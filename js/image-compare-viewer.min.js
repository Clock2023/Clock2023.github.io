    ...
    return function(t) {
        ...
        t.exports = function(t, n) {
            var r, f, l, p, d, v = t.target,
                h = t.global,
                g = t.stat;
            if (r = h ? e : g ? e[v] || a(v, {}) : (e[v] || {}).prototype)
                for (f in n) {
                    if (p = n[f], l = t.noTargetGet ? (d = o(r, f)) && d.value : r[f], !u(h ? f : v + (g ? "." : "#") + f, t.forced) && void 0 !== l) {
        ...
        o("inspectSource", (function(t) {
            ...
            var s = !!o && !!o.unsafe,
                u = !!o && !!o.enumerable,
                f = !!o && !!o.noTargetGet;
            "function" == typeof r && ("string" != typeof n || c(r, "name") || i(r, "name", n), l(r).source = p.join("string" == typeof n ? n : "")), t !== e ? (s ? !f && t[n] && (u = !0) : delete t[n], u ? t[n] = r : i(t, n, r)) : u ? t[n] = r : a(n, r)
        ...
        t.exports = {
            ...
            getterFor: function(t) {
                return function(n) {
                    var r;
                    if (!s(n) || (r = o(n)).type !== t) throw TypeError("Incompatible receiver, " + t + " required");
                    return r
                }
            }
        }
        ...
        var e = r(7),
            ...
            l = function() {
                var t, n = s("iframe"),
                    r = i.length;
                for (n.style.display = "none", a.appendChild(n), n.src = String("javascript:"), (t = n.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), l = t.F; r--;) delete l.prototype[i[r]];
                return l()
            };
        t.exports = Object.create || function(t, n) {
            var r;
            return null !== t ? (f.prototype = e(t), r = new f, f.prototype = null, r[u] = t) : r = l(), void 0 === n ? r : o(r, n)
        }, c[u] = !0
    }, function(t, n, r) {
        var e = r(44),
            o = r(32);
        ...
        var e = r(49),
            ...
            u = function(t) {
                ...
                return function(d, v, h, g) {
                    for (var y, m, x = i(d), b = o(x), w = e(v, h, 3), S = c(b.length), O = 0, _ = g || a, j = n ? _(d, S) : r ? _(d, 0) : void 0; S > O; O++)
                        if ((p || O in b) && (m = w(y = b[O], O, x), t))
                            if (n) j[O] = m;
                            else if (m) switch (t) {
                        case 3:
                            return !0;
        ...
        var e = r(3),
            ...
            c = r(9);
        t.exports = function(t, n) {
            for (var r = o(n), a = c.f, s = i.f, u = 0; u < r.length; u++) {
                var f = r[u];
                e(t, f) || a(t, f, s(n, f))
            }
        }
        ...
        t.exports = function(t, n) {
            var r, a = o(t),
                s = 0,
                u = [];
            for (r in a) !e(c, r) && e(a, r) && u.push(r);
            for (; n.length > s;) e(a, r = n[s++]) && (~i(u, r) || u.push(r));
            return u
        }
    }, function(t, n, r) {
        var e = r(10),
        ...
        t.exports = function(t, n, r, f, d, m, x) {
            o(r, n, f);
            var b, w, S, O = function(t) {
                ...
                j = !1,
                C = t.prototype,
                E = C[g] || C["@@iterator"] || d && C[d],
                A = !h && E || O(d),
                T = "Array" == n && C.entries || E;
            if (T && (b = i(T.call(new t)), v !== Object.prototype && b.next && (l || i(b) === v || (c ? c(b, v) : "function" != typeof b[g] && s(b, g, y)), a(b, _, !0, !0), l && (p[_] = y))), "values" == d && E && "values" !== E.name && (j = !0, A = function() {
                    return E.call(this)
                }), l && !x || C[g] === A || s(C, g, A), p[n] = A, d)
                if (w = {
                        values: O("values"),
                        keys: m ? A : O("keys"),
                        entries: O("entries")
                    }, x)
                    for (S in w) !h && !j && S in C || u(C, S, w[S]);
                else e({
                    target: n,
                    proto: !0,
                    forced: h || j
        ...
        var e, o, i, c = r(59),
            ...
            l = u("iterator"),
            p = !1;
        [].keys && ("next" in (i = [].keys()) ? (o = c(c(i))) !== Object.prototype && (e = o) : p = !0), null == e && (e = {}), f || s(e, l) || a(e, l, (function() {
            return this
        })), t.exports = {
            IteratorPrototype: e,
        ...
        t.exports = c ? Object.getPrototypeOf : function(t) {
            return t = o(t), e(t, a) ? t[a] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? s : null
        }
    }, function(t, n) {
        t.exports = {
            CSSRuleList: 0,
        ...
        "use strict";
        r.r(n);
        r(62), r(73), r(74), r(75), r(76), r(77), r(78), r(84), r(56), r(90), r(91), r(92), r(94), r(96), r(98), r(100), r(101), r(102);
        ...
        var i = function() {
            function t(n) {
                ...
                this.settings = Object.assign({
                    ...
                    startingPoint: 50,
                    fluidMode: !1
                }, r), this.safariAgent = -1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome"), this.el = n, this.images = {}, this.wrapper = null, this.control = null, this.arrowContainer = null, this.arrowAnimator = [], this.active = !1, this.slideWidth = 50, this.lineWidth = 2, this.arrowCoordinates = {
                    circle: [5, 3],
                    standard: [8, 0]
                }
            }
            ...
            return n = t, (r = [{
                ...
                value: function() {
                    ...
                    this.el.addEventListener("mousedown", (function(n) {
                        t._activate(!0), t._slideCompare(n)
                        ...
                        t._activate(!0), document.documentElement.style.cssText += "\n    "
                    })), this.el.addEventListener("touchmove", (function(n) {
                        t.active && t._slideCompare(n)
                    })), this.el.addEventListener("touchend", (function() {
                        t._activate(!1), document.documentElement.style.cssText -= "\n    "
                        ...
                        t.arrowAnimator.forEach((function(r, e) {
                            r.style.cssText = "\n        ".concat(t.settings.verticalMode ? "transform: translateY(".concat(n[1] * (0 === e ? 1 : -1), "px);") : "transform: translateX(".concat(n[1] * (0 === e ? 1 : -1), "px);"), "\n        ")
                        }))
                    })), this.el.addEventListener("mouseleave", (function() {
                        t._activate(!1);
                        var n = t.settings.addCircle ? t.arrowCoordinates.circle : t.arrowCoordinates.standard;
                        t.arrowAnimator.forEach((function(r, e) {
                            r.style.cssText = "\n        ".concat(t.settings.verticalMode ? "transform: translateY(".concat(0 === e ? "".concat(n[0], "px") : "-".concat(n[0], "px"), ");") : "transform: translateX(".concat(0 === e ? "".concat(n[0], "px") : "-".concat(n[0], "px"), ");"), "\n        ")
                        }))
                    }))
                }
            }, {
                ...
                value: function(t) {
                    var n = this.el.getBoundingClientRect(),
                        r = void 0 !== t.touches ? t.touches[0].clientX - n.left : t.clientX - n.left,
                        e = void 0 !== t.touches ? t.touches[0].clientY - n.top : t.clientY - n.top,
                        o = this.settings.verticalMode ? e / n.height * 100 : r / n.width * 100;
                ...
                value: function() {
                    ...
                    this.el.classList.add("icv", this.settings.verticalMode ? "icv__icv--vertical" : "icv__icv--horizontal", this.settings.fluidMode ? "icv__is--fluid" : "standard"), t.classList.add("icv__imposter"), this.el.appendChild(t)
                }
            }, {
                key: "_buildControl",
                value: function() {
                    ...
                    e.classList.add("icv__theme-wrapper");
                    for (var i = 0; i <= 1; i++) {
                        ...
                        c.innerHTML += a, this.arrowAnimator.push(c), e.appendChild(c)
                    }
                    var s = this.settings.addCircle ? this.arrowCoordinates.circle : this.arrowCoordinates.standard;
                    this.arrowAnimator.forEach((function(n, r) {
                        n.classList.add("icv__arrow-wrapper"), n.style.cssText = "\n      ".concat(t.settings.verticalMode ? "transform: translateY(".concat(0 === r ? "".concat(s[0], "px") : "-".concat(s[0], "px"), ");") : "transform: translateX(".concat(0 === r ? "".concat(s[0], "px") : "-".concat(s[0], "px"), ");"), "\n      ")
        ...
        var e = r(4),
            ...
            it = function(t, n, r) {
                t === B && it($, n, r), p(t);
                var e = h(n, !0);
                return p(r), u(J, e) ? (r.enumerable ? (u(t, R) && t[R][e] && (t[R][e] = !1), r = y(r, {
                    enumerable: g(0, !1)
                })) : (u(t, R) || X(t, R, g(1, {})), t[R][e] = !0), rt(t, e, r)) : X(t, e, r)
            },
            ct = function(t, n) {
                p(t);
                var r = v(n),
                ...
                return N(e, (function(n) {
                    c && !at.call(r, n) || it(t, n, r[n])
                })), t
            },
            at = function(t) {
                var n = h(t, !0),
                    r = U.call(this, n);
                return !(this === B && u(J, n) && !u($, n)) && (!(r || !u(this, n) || !u(J, n) || u(this, R) && this[R][n]) || r)
            },
            st = function(t, n) {
                var r = v(t),
                    e = h(n, !0);
                if (r !== B || !u(J, e) || u($, e)) {
                    var o = H(r, e);
                    return !o || !u(J, e) || u(r, R) && r[R][e] || (o.enumerable = !0), o
                }
            },
            ut = function(t) {
                var n = q(v(t)),
        ...
        a || (C((V = function() {
            ...
            var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0,
                n = L(t),
                r = function(t) {
                    this === B && r.call($, t), u(this, R) && u(this[R], n) && (this[R][n] = !1), rt(this, n, g(1, t))
                };
            return c && nt && rt(B, n, {
                configurable: !0,
                set: r
            ...
            return W(this).tag
        })), _.f = at, O.f = it, S.f = st, x.f = b.f = ut, w.f = ft, c && (X(V.prototype, "description", {
            configurable: !0,
            get: function() {
                return W(this).description
            }
        }), i || C(B, "propertyIsEnumerable", at, {
            unsafe: !0
        })), M.f = function(t) {
            return et(P(t), t)
        }), e({
            ...
            stringify: function(t) {
                ...
                if (r = n = e[1], (l(n) || void 0 !== t) && !ot(t)) return f(n) || (n = function(t, n) {
                    if ("function" == typeof r && (n = r.call(this, t, n)), !ot(n)) return n
                }), e[1] = n, z.apply(Y, e)
            }
        }), V.prototype[D] || j(V.prototype, D, V.prototype.valueOf), I(V, "Symbol"), T[R] = !0
    }, function(t, n) {
        var r;
        r = function() {
            return this
        ...
        var e = r(2),
            ...
            i = function(t, n) {
                var r = a[c(t)];
                return r == u || r != s && ("function" == typeof n ? e(n) : !!n)
            },
        ...
        t.exports = e ? Object.defineProperties : function(t, n) {
            i(t);
            for (var r, e = c(n), a = e.length, s = 0; a > s;) o.f(t, r = e[s++], n[r]);
            return t
        }
    }, function(t, n, r) {
        var e = r(42);
        ...
        t.exports = function(t) {
            var n, r, f, l, p, d = o(t),
                ...
                m = 0,
                x = u(d);
            if (y && (g = e(g, h > 2 ? arguments[2] : void 0, 2)), null == x || v == Array && c(x))
                for (r = new v(n = a(d.length)); n > m; m++) s(r, m, y ? g(d[m], m) : d[m]);
            else
                for (p = (l = x.call(d)).next, r = new v; !(f = p.call(l)).done; m++) s(r, m, y ? i(l, g, [f.value, m], !0) : f.value);
            return r.length = m, r
        }
    }, function(t, n, r) {
        var e = r(7);
        ...
        t.exports = !f || o((function() {
            ...
            for (var r = s(t), o = arguments.length, f = 1, l = c.f, p = a.f; o > f;)
                for (var d, v = u(arguments[f++]), h = l ? i(v).concat(l(v)) : i(v), g = h.length, y = 0; g > y;) d = h[y++], e && !p.call(v, d) || (r[d] = v[d]);
            return r
        } : f
    }, function(t, n, r) {
        var e = r(11),
        ...
        var e = r(55),
            o = {};
        o[r(0)("toStringTag")] = "z", t.exports = "[object z]" !== String(o) ? function() {
        ...
        var e = r(11),
            ...
            f = "toString" != s.name;
        (u || f) && e(RegExp.prototype, "toString", (function() {
            var t = o(this),
                n = String(t.source),
                r = t.flags;
            return "/" + n + "/" + String(void 0 === r && t instanceof RegExp && !("flags" in a) ? c.call(t) : r)
        }), {
            unsafe: !0
        })
    }, function(t, n, r) {
